[The Collection FrameWork](./README.md) | [Previous](./Getting_to_Know_the_Collection_Hierarchy.md)|  Storing Elements in a Collection |[Next](./Iterating_over_the_Elements_of_a_Collection.md)
-----------------
