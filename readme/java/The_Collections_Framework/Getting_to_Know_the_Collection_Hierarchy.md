[The Collection FrameWork](./README.md) | [Previous](./Storing_Data_Using_the_Collections_Framework.md)  |  Getting to Know the Collection Hierarchy | [Next](./Storing_Elements_in_a_Collection.md)
-----------------
